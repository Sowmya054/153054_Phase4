...
public class CustomerActionController {
	...
	@RequestMapping(value = "/viewMinBalPage")
	public ModelAndView getviewMinBal() {
		List<Customer> customer = walletService.MinBalCustomers();

		return new ModelAndView("viewMinBalPage", "customer", customer);
	}
